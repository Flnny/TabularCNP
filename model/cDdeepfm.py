...
from model.base import Dnn, Linear, DeepFM
...
class DeterministicEncoder(nn.Module):
    def __init__(self, sizes, mask_sizes, num_embeddings, embedding_dim, dense_features, sparse_features, hidden_units):
        ...
        self.deepfm = DeepFM(num_embeddings, embedding_dim, dense_features, sparse_features, hidden_units)
